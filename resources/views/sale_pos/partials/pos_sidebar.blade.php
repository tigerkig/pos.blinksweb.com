...
<div class="row">
	...
	<div class="col-sm-6 @if(empty($featured_products)) hide @endif" id="feature_product_div">
		...
		<div class="grid-container">
			<main class="grid-item main">
				<div class="items">
					@foreach($categories as $category)
						<div class="item">
							<button type="button" class="custom-pos-button" onclick=customPosCategoryClick("{{$category['id']}}")>{{$category['name']}}</button>
						</div>
					@endforeach
				</div>
			</main>
...
<div class="row custom-pos_sidebar-list">
	<input type="hidden" id="suggestion_page" value="1">
	<div class="col-md-12 custom-pos_sidebar-list-padding">
