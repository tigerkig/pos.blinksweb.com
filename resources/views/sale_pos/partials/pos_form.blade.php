	...
	<div class="col-md-4">
		<div class="form-group">
			<div class="input-group">
				<span class="input-group-addon custom-border-radius">
				...
				<span class="input-group-btn custom-plus-button">
					<button type="button" class="btn btn-flat add_new_customer" data-name=""  @if(!auth()->user()->can('customer.create')) disabled @endif><i class="fa fa-plus fa-lg"></i></button>
				</span>
			</div>
		...
		<div class="form-group">
			<div class="input-group">
				<div class="input-group-btn">
					<button type="button" class="btn btn-default bg-white btn-flat custom-border-radius" data-toggle="modal" data-target="#configure_search_modal" title="{{__('lang_v1.configure_product_search')}}"><i class="fas fa-search-plus"></i></button>
				</div>
				...
				<span class="input-group-btn custom-plus-button">
					...
					<button type="button" class="btn btn-default bg-white btn-flat pos_add_quick_product" data-href="{{action('ProductController@quickAdd')}}" data-container=".quick_add_product_modal"><i class="fa fa-plus fa-lg"></i></button>
				</span>
			</div>
		</div>
	</div>
